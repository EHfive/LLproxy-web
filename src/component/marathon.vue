            ...
            <div>
                <mu-table class="livetable" :selectable="false" :showCheckbox="false" :fixedHeader="false"
                    ...
                    <mu-thead slot="header" class="tbth">
                        <mu-th class="wtcover">持有pt/总pt</mu-th>
        ...
        data(){
            return {
                ...
                eventlist: [
                    {
                        event_id: 67,
                        title: "别离开我 You are my love",
                        begin: {
                            "time": "2017-06-07 15:00:00",
                            "timestamp": 1496818800
                        },
                        end: {
                            "time": "2017-06-16 14:00:00",
                            "timestamp": 1497592800
                        },
                        type: 1
                    },
                    {
                        ...
                        "title": "\u7814\u7a76\u5fc5\u8981",
                        "begin": {
                            "time": "2017-03-27 15:00:00",
                            "timestamp": 1490598000
                        },
                        "end": {
                            "time": "2017-04-05 14:00:00",
                            "timestamp": 1491372000
                        },
                        "tiers": {
                            "tier1": {
                                "rank": "2300",
            ...
            fetchData (reload = true) {
                ...
                axios.get(util.api_server + 'llproxy/eventMarathon/', {
                    params: {
                        ...
                        shownormal: this.shownormal || null
                    }
                })
                    .then(function (response) {
